...
using GameHub.Hash.View;


namespace GameHub.Hash.Model
{
    public class Jogo
    {

        public string VerificarGanhador(string[,] tabuleiro)
        {
        ...
        public string ConverterParaJSON(int vitoriasJogador1, int vitoriasJogador2, int empates, int quantidadePartidas)
        {
        ...
        public void ConverterParaObjeto(string json)
        {
        ...
        public void SalvarDadosJogo(int vitoriasJogador1, int vitoriasJogador2, int empates, int quantidadePartidas)
        {
        ...
        public void MostrarHistoricoPartidasAnteriores()
        {
        ...
        public void Jogar()
        {
            ...
            while (true)
            {
                ...
                if (inicializacaoVariaveis)
                {
                    ...
                    tab.MostrarJogoDaVelha(jogador, tabuleiro);
